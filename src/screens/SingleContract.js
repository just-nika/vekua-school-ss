...
const SingleContract = () => {
        ...
        return <>
            <div ref={componentRef} className="contract">
                ...
                <p style={{textAlign: "start"}}>
                    ...
                    2.1.2. ვალდებულია <b>წინასწარ, ყოველი თვის დასაწყისში, არაუგვიანეს 5 რიცხვისა, გადაიხადოს მთლიანი თვის საფასური - 70 ლარი, მიხედავად იმისა მსმენელი დაესწრება თუ არა მეცადინეობებს</b>.<br />
                ...
                <p style={{textAlign: "start"}}>
                    ...
                    <b>ბ) არ აანაზღაუროს დამკვეთის წარმომადგენლის (მსმენელის) მიერ გაცდენილი საათები, არც ფინანსურად და არც ფიზიკურად (აუდიტორიაში დამატებითი მუშაობის სახით);</b>
                ...
                <p style={{textAlign: "start"}}>
                    ...
                    3.3. <b>დამკვეთი ვალდებულია აუნაზღაუროს შემსრულებელს გაწეული მომსახურების საფასური, რაც შეადგენს ყოველ კალენდარულ თვეში 70 ლარს</b>.<br />
                ...
                <p style={{textAlign: "start"}}>
                    4.1. წინამდებარე ხელშეკრულება ძალაში შედის ხელმოწერისთანავე და/ან  სწავლების  პროცესში ჩართვისთანავე და მოქმედებს 2020_2021 სასწავლო წლის ბოლომდე, პროგრამის ამოწურვამდე. <br />
    ...
    return (
      <div>
        <br />
        <h3 style={{color: "red"}}>ხელშეკრულების ამოსაბეჭდად გამოიყენეთ საიტის Light Mode</h3>
        <ComponentToPrint />
