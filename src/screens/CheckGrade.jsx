  ...
  function DatesA() {
    if (forCard.class === 7 || forCard.class === "7") {
      ...
      if (forCard.m || forCard.p) {
        if (forCard.m && !forCard.p) {
          swal(`მოსწავლემ უნიკალური კოდით ${forCard.class}-${forCard.code}, 3 ივლისს ჩატარებულ მათემატიკის სარეკომენდაციო წერაზე მიიღო ${forCard.m} ქულა.`)
          return <h3>ქულის ხილვის გვერდზე დასაბრუნებლად, გთხოვთ გადატვირთოთ გვერდი</h3>
        }else if (!forCard.m && forCard.p) {
          swal(`მოსწავლემ უნიკალური კოდით ${forCard.class}-${forCard.code}, 5 ივლისს ჩატარებულ ფიზიკის სარეკომენდაციო წერაზე მიიღო ${forCard.p} ქულა.`)
          return <h3>ქულის ხილვის გვერდზე დასაბრუნებლად, გთხოვთ გადატვირთოთ გვერდი</h3>
        }else if (forCard.m && forCard.p) {
          swal(`მოსწავლემ უნიკალური კოდით ${forCard.class}-${forCard.code}, 3 ივლისს ჩატარებულ მათემატიკის სარეკომენდაციო წერაზე მიიღო ${forCard.m} ქულა, ხოლო 5 ივლისს ჩატარებულ ფიზიკის შეფასებაა ${forCard.p} ქულა.`)
          return <h3>ქულის ხილვის გვერდზე დასაბრუნებლად, გთხოვთ გადატვირთოთ გვერდი</h3>
        }
      }else {
        swal(`მოსწავლეს სარეკომენდაციო წერა არ უწერია.`)
      ...
      <div className="container" id="checking">
        ...
        {forCard ? (
          ...
          <>
            <br />
            <h1>
            მიმდინარე წლის 2 ივლისს ჩატარებული სარეკომენდაციო წერების შედეგები შეგიძლიათ იხილოთ სკოლის ვებ. გვერდზე <a href="/exams">vekua42.edu.ge</a> მოსწავლის პირადი ნომრის მითითებით.
            </h1>
            <div className="info-text" style={{ textAlign: "start", margin: "0", fontSize: "16px" }}>
              ...
              <br />
              <p>სააპელაციო განაცხადის ფორმების შევსება მოხდება სკოლაში 7-8 ივლისს, 17 საათამდე.</p>
              <br />
              ...
              <p>3 და 5 ივლისს ჩატარებული წერის შედეგები გამოქვეყნდება ეტაპობრივად.</p>
            </div>
